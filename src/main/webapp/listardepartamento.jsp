					...
					<div class="row" style=" background-image: url('Imagens/Back-tab.png');">
					    ...
					    <thead>
					        <tr>
					            <th>Código</th>
					            <th>Nome</th>
					            <th>Mat. Responsável</th>
					            <th align="center">Excluir</th>
					        </tr>
					    </thead>

					   <c:forEach items="${listaDepartamento}" var="dep">
			               <tr style="height: auto;">
			               		
				                <td>${dep.codigo}</td>
				                <td>${dep.nome}</td>
				                <td>${dep.matriculaaResponsavel}</td>
				                <td ><a class="btn btn-sm btn-danger" href="ServletDep?acao=excluir&codigo=${dep.codigo}"><span class="glyphicon glyphicon-remove"></span></a></td>
						...
						<a href="ServletDep?acao=listar" class="btn btn-info">Listar <span class="glyphicon glyphicon-list"></span></a>
